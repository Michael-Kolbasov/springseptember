...
//        ctx.close();
        ApplicationContext act = new AnnotationConfigApplicationContext(ApplicationConfiguration.class);
        Unicorn unicorn = (Unicorn) act.getBean("unicorn");
        unicorn.doAnimalStuff();
